...
const styles = StyleSheet.create({
  ...
  choice: { flexDirection: 'row', alignItems: 'center', borderWidth: 2, borderBottomWidth: 2, borderColor: palette.line, borderRadius: radius.md, padding: 18, marginBottom: space.md, backgroundColor: palette.bg },
  choiceSelected: { flexDirection: 'row', alignItems: 'center', borderWidth: 2, borderBottomWidth: 2, borderColor: palette.blue, borderRadius: radius.md, padding: 18, marginBottom: space.md, backgroundColor: palette.blueSoft },
  choiceCorrect: { flexDirection: 'row', alignItems: 'center', borderWidth: 2, borderBottomWidth: 2, borderColor: palette.greenDark, borderRadius: radius.md, padding: 18, marginBottom: space.md, backgroundColor: palette.greenSoft },
  choiceWrong: { flexDirection: 'row', alignItems: 'center', borderWidth: 2, borderBottomWidth: 2, borderColor: palette.redDark, borderRadius: radius.md, padding: 18, marginBottom: space.md, backgroundColor: palette.redSoft },
